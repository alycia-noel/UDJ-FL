...
def main(r):
    ...
    if args.dataset == 'dirtymnist':
        with open(f'data_files/final/large_clean_train_dirtymnist_{args.round}.pkl', 'rb') as f:  
            train_loaders = pickle.load(f)

        with open(f'data_files/final/large_clean_test_curetsr_{args.round}.pkl', 'rb') as f:  
            test_loaders = pickle.load(f)

        with open(f'data_files/final/large_clean_testloader_curetsr_{args.round}.pkl', 'rb') as f:  
